...
public class FileSecret {
     ...
     */
    public static void encrypt(File file2Encrypt,File destination) throws IOException {
     ...
     */
    public static void decode(File fileHasEncrypted,File destination) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File dest = new File("D://desktop//ziptest.file");//加密后文件位置
